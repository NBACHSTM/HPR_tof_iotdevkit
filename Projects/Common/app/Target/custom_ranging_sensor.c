  ...
  if (Instance >= CUSTOM_RANGING_INSTANCES_NBR)
  {
  ...
  else
    {
	 ...
	 /* USER CODE BEGIN MX_GPIO_Init_1 */
	   ...
	   /*Configure GPIO pins : PB4 UCPD_PWR_Pin */
	   ...
	   /*Configure GPIO pin : Mems_VL53_xshut_Pin */
...
/**
  ...
  * @retval BSP status
  */
int32_t CUSTOM_RANGING_SENSOR_GetDistance(uint32_t Instance)
{
  int32_t ret;
  ...
  else if (CUSTOM_RANGING_Drv[Instance]->GetDistance(CUSTOM_RANGING_CompObj[Instance] ) < 0)
  {
    ret = BSP_ERROR_COMPONENT_FAILURE;
  }
  else
